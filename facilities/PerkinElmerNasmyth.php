  ...
  <div id="container_all">
    ...
    <!-- mainbody is subdivided into leftpanel and smaller rightpanel -->
      ...
      <div id="leftpanel">
        ...
        <h3>UltraView Spinning Disk system (Nasmyth)</h3>
        <p>New Biochemistry Room 00-031</p>
        <p>&nbsp;</p>
        <p>Spinning-disc confocal microscope (Ultra- VIEW VoX; PerkinElmer; mounted on an IX81 microscope [Olympus]; 60× 1.3 NA silicon immersion objective and an electron-multiplying charge-coupled device camera [ImagEM; Hamamatsu Photonics]).</p>
        <p>&nbsp;</p>
<p>The UltraView system is a spinning disc confocal, providing optical sectioning while still permitting rapid imaging, on the order of 20 frames/s. It has 6 laser lines, 405, 488, 514, 532, 568 and 633. This allows a very wide range of fluorescent probes to be used on the system. The instrument is also fitted with a photo-bleach/activation unit, which can be used to provide either single spots or arbitrary shapes via line or raster scans. This instrument is particularly useful for doing live cell imaging as the high imaging speed and low background provide crisp images of even fast moving objects in live cells.</p>
...
<p>&nbsp;</p>
  ...
  <tr>
    ...
    <td></td>
      ...
      <div id="rightpanel">
        <a name="software">
        <img id="spinning disc" src="images/sdisk_thumb.jpg"  width="200" height="133"
              alt="Spinning Disc" title="Spinning Disc"/>
        <p></p>
        <ul>
		   <li>
	                    <a href="http://micronwiki.bioch.ox.ac.uk/wiki/UltraView_spinning_disk_(Nasmyth)">Spinning Disc Wiki</a>
                        	                </li>
	                ...
	                <li>
	                    ...
	                    <a href="http://www.perkinelmer.com/pages/020/cellularimaging/technologies/spinningdiskconfocal.xhtml" target="_blank">Perkin Elmer</a>
            </li>
                
		        
		    
	                <li>
	                    <a href="../resources/Nasmyth Ultraview spinning disk.pdf" target="_blank">Specifications</a>
	                </li>
		        <li>
	                    <a href="../resources/Ultraview Vox User Protocol Nasmyth 01.pdf" target="_blank">Spinning Disc Users Manual</a>
	                </li>
        </ul>
      </div>
