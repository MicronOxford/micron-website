...
<?php print $image_caption ?></span>
        ...
        <ul>
          <li><img src="images/nano.jpg" width="80" height="38"> </li>
          <li><a href="research/micron_publications.shtml" 
            title="publications">Publications</a>, 
         <a href="micron_research.shtml" title="research">Research</a>,
         <a href="micron_gallery.php" title="more research images">More Research Images</a></li>
      ...
      <div id="rightpanel">
        ...
        <div id="newswidget">
            ...
            }).render().setUser('NanoscopyOxford').start();
            </script>
        </div>
